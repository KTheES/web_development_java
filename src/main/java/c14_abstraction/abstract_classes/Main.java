...
/*
    ...
    2. 서브 클래스에서 슈퍼 클래스로 메서드를 호출할 때 사용 -> super.메서드명()
     ...
     생성할 클래스 목록
     Factoy.java                -> 얘가 디자인 패턴 중 Factory 형태는 아닙니다.
     PhoneFactory.java          -> factory 상속 받으세요
     TableFactory.java          ->factory 상속 받으세요
 */
public class Main {
    public static void main(String[] args) {
        ...
        phoneFactory1.produce("아이폰 16 프로");
        ...
        phoneFactory1.manage();     //Factory.java에 있던 추상 메서드 manage를
                                    //override 해서 재정의한 PhoneFactory만의 메서드
