...
//         2. Setter / Getter 란?
                ...
                Setter
                 ...
                 Getter
                    ...
                    Person.java / PersonMain.java를 확인할 것 -> 응용 코드 작성

                    수업 내용 확인을 위해 파일 내부를 검색하려면 -> ctrl + f
                    여태까지 수업한 전체 패키지 및 파일 확인에서 내용 확인 하려면 -> ctrl + shift + f
            ...
            4. 그래서 Setter / Getter 는 언제나 필수적인가?
                모든 경우에 Setter / Getter 가 필수적인 것은 '아닙니다'
                하지만 일정 사이즈 이상의 프로젝트를 진행해서 다수의 데이터를 입력 받을 경우
                적절한 데이터임을 검증하는 과정을 명시하기 위해서는
                Setter / Getter 를 이용하는 것이 '효과적'입니다.

                거의 대부분 사용하기 때문에 alt + insert등을 지원하고
                추후 수업할 lombok 에너테이션을 사용하는 편입니다.
