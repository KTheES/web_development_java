...
/*
    PersonLombok.java
    PersonLombokMain.java 생성
 */
public class PersonLombokMain {
    public static void main(String[] args) {
//        PersonLombok personLombok1 = PersonLombok.builder()  // 직접 짰다는 의미(바닐라)
//                .name("김일")                                 // 바닐라로 짰을 때와 달리
//                .build();                                    // @Builder 이용했을 떄는
//                                                             // builder().build()입니다(대문자가 아니라)
//
//        // personLombok 2-5까지 직접 만들어보세요.
...
//        System.out.println(personLombok5);
        ...
        PersonLombok personLombok6 =PersonLombok.builder().build();
