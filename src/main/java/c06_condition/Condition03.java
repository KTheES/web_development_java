...
public class Condition03 {
    public static void main(String[] args) {
        /*
            ...
            실행문1 : 조건식이 true 일 경우 실행되는 식
            실행문2 : 조건식이 false 일 경우 실행되는 식
         */
...
//        System.out.println("더 큰 수는 " + max +"입니다.");
        ...
        String exampleSenence ="";
//        if(num >= 0) {
//            System.out.println("num은 양수이거나 0입니다.");
//        }else {     // else 는 if 가 false 일 떄 실행되는 최종 조건문이므로 조건식이
//                    //포함되지 않음  -> num이 0 미만인 경우 // num < 0
//            System.out.println("num은 음수입니다.");
//        }
        // 이상의 if - else 구문을 3항 연산자로 바꾸시오.
        exampleSenence = num >= 0  ? "num은 양수이거나 0입니다" : "num은 음수입니다" ;  // 삼항연산자 조건식 시작
        System.out.println(exampleSenence);
