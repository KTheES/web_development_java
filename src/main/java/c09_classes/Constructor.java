...
/*
    ...
    2. return 값이 없다. -> 마치 call1(), call2() 유형같은 식으로 받아들일 수 있습니다.
...
public class Constructor {
    ...
    Constructor(int number){
        ...
        this.num =number;   //this :해당 클래스에서 객체를 만들게 되면 객체 이름으로 대체되는 것.
                            ...
                            // 여기서 여러분이 명심하셨으면 하는 바는 매개변수 number와 멤버 변수 num과는
                            // 대입 연산자 = 전까지는 서로 다른 개념입니다.
    }

    //매개변수 생성자를 직접 만드세요 -> 매개변수 String title로 고정
    // 생성자가 호출될 때 RequiredArgsConstructor(int 매개변수를 필수로 요구하는 생성자) 가 콘솔에 찍히도록 작성하세요.
    // 이후 ConstructorMain 에서 Constructor constructor4 = new Constructor("김일"); 을 통해 객체를 생성하세요.
