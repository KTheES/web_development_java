...
/*
    ...
    다차원 배열은 2 차원 이상의 배열을 의미하지만, 개발 환경 상 2차원 배열 이상을 사용하는 경우는 극히
...
//
//        System.out.println(Arrays.toString(arr3));  // Array.toString()의 경우 1차배열에만 적용됨
...
//        }
        ...
        // 2차 배열을 기준으로 할 떄 첫번째 반복문을 작성할 경우 2차 배열의 요소인 1차 배열들이 나옴
