...
//        System.out.print("MBTI 는 어떻게 됩니까 ? >>> ");
...
//        System.out.println("제 이름은"+name+"이고, 나이는 "+age+"살입니다. \n"+school+"에 재학 중이며, MBTI는 "+mbti+"입니다.");
        ...
        // pantsColor와 lastFood 를 이용하여 밴드 네임을 출력하세요.
        // 당신의 밴드 이름은 그레이 시리얼입니다.


//        System.out.println("지금 입고 있는 하의 색깔과 마지막으로 먹은 음식을 더하여 밴드 이름을 만들어주는 프로그램입니다.");
//        System.out.print("지금 입고 있는 하의 색깔이 무엇인가요? >>> ");
